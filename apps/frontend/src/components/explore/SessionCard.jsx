  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden hover:shadow-lg transition-shadow">
      <div className="p-6">
        ...
        {/* AI Take - Clear label for AI reasoning */}
        {reasoning && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-semibold text-purple-700 uppercase tracking-wide">AI Take</span>
                  <span className="text-xs text-purple-500">Why this session?</span>
                </div>
        ...
        {/* Description Preview (only if no AI reasoning) */}
