...
export default function ModeratorLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      {/* Main Content */}
      <main className="lg:ml-64 min-h-screen pb-24 lg:pb-0 overflow-x-hidden">
        <div className="pt-28 lg:pt-8 px-4 pb-6 lg:px-8 max-w-4xl mx-auto w-full overflow-x-hidden">
          <Outlet />
        </div>
      </main>
