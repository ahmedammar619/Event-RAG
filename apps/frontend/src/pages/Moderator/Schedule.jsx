    ...
    <div className="pb-6">
      ...
      {assignments.length === 0 ? (
        <div className="bg-white rounded-2xl p-8 text-center shadow-sm border border-slate-200">
          ...
          <Link to="/portal/availability" className="inline-flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-xl font-medium hover:bg-blue-700 transition-colors">
            Set Availability
          </Link>
        </div>
      ) : (
                            ...
                            {!isEditing && (
                              ...
                              >
                                {headcount ? (
                                  ...
                                  <>
                                    <div className="text-sm font-bold text-blue-600">+ Add</div>
                            ...
                            <div className="flex gap-2">
                              <div className="flex-1 relative">
                                <input
                                  type="number"
                                  inputMode="numeric"
                                  className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-lg font-semibold text-center focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
