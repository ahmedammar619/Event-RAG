                  ...
                  <div className="p-4">
                    {!hasSlots ? (
                      <button
                        ...
                        className="w-full py-4 border-2 border-dashed border-slate-200 rounded-xl text-slate-400 hover:border-blue-400 hover:text-blue-600 transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      <div className="space-y-3">
                        {daySlots.map((slot, index) => (
                          <div key={index} className="flex items-center gap-2 p-3 bg-slate-50 rounded-xl">
                            <div className="flex-1 grid grid-cols-2 gap-2">
                              <select
                                className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <button
                          onClick={() => addSlot(day.id)}
                          className="w-full py-2.5 border-2 border-dashed border-slate-200 rounded-xl text-slate-400 hover:border-blue-400 hover:text-blue-600 transition-colors text-sm font-medium"
                        >
                          + Add Another
                        </button>
                      </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 mb-6">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                >
                  <div className={`text-sm font-semibold ${schedulePreference === opt.value ? 'text-blue-700' : 'text-slate-700'}`}>
                    {opt.label}
                  </div>
          ...
          {hasChanges && (
            <div className="sticky bottom-4">
              <button
                ...
                disabled={saving}
                className="w-full py-4 bg-blue-600 text-white rounded-xl font-semibold shadow-lg hover:bg-blue-700 transition-colors disabled:opacity-50"
              >
